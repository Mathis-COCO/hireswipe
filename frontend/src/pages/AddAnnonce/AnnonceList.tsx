...
const getCityFromLocation = (location: string) => {
  if (!location) return '';
  // Prend le premier mot avant une virgule ou tout si pas de virgule
  ...
  return (
    <div className={styles.listWrapper} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <div className={styles.header}>
        ...
        <button className={styles.newBtn} onClick={handleNewClick}>+ Nouvelle annonce</button>
      </div>
      <div className={styles.annonces} style={{ width: '100%', maxWidth: 900 }}>
        {annonces && annonces.length > 0 && annonces.map(a => (
            ...
            <div className={styles.annonceHeader}>
              <div>
                ...
                <div className={styles.annonceMeta}>
                  <span>{getCityFromLocation(a.location)}</span>
            ...
            <div className={styles.annonceFooterRow}>
              <div className={styles.annonceFooterInfos}>
                ...
                <div className={styles.tagsRow}>
                  {a.skills && a.skills.map(s => <span key={s} className={styles.tag}>{s}</span>)}
                </div>
              </div>
